//
//  TestFontWeightDomParsing.swift
//  Web
//
...
class TestFontWeightDomParsing: TestCSSDOM {
...
//        
//        let fontWeightElement = domFromCSSProperty(sourceString, document: CSSDOMDocument(), propertyName: "font-weight" )
//        
//        if let fontWeightElement = fontWeightElement {
//            
//            if let childList = fontWeightElement.childNodes {
//                
