...
///
public final class XMLSerializer: AttributesSerializer {
    
    /// Singleton instance.
    static var shared = XMLSerializer()
    ...
    ///
    func xmlSerialize(_ root: Node, contextNamespace namespace: inout String?, namespacePrefixMap: [String: String], generatedNamespacePrefixIndex prefixIndex: inout Int, requireWellFormed: Bool = true) throws -> String? {
    ...
    ///
    public func serializeXMLAttributes(_ element: Element, namespacePrefixMap: inout [String: String], generatedNamespacePrefixIndex prefixIndex: inout Int, ignoreNamespaceDefinitionAttribute: Bool, duplicatePrefixDefinition: String?, requireWellFormed: Bool) throws -> String {
