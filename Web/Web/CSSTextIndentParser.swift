...
final class CSSTextIndentParser : CSSComponentsParser {
    
    let validatorDelegate: CSSTextIndentValidatorDelegate
    
    override init(componentValueArray: [CSComponentValue] ) {
        
        self.validatorDelegate = CSSTextIndentValidatorDelegate()
