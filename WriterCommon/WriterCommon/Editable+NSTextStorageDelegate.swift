//
//  Editable+NSTextStorageDelegate.swift
//  WriterCommon-mac
//
//  Created by Sebastien Hamel on 2020-04-22.
...
extension Editable {
    ...
    public func textStorage(_ textStorage: NSTextStorage, willProcessEditing editedMask: NSTextStorageEditActions, range editedRange: NSRange, changeInLength delta: Int) {
        ...
        if editedMask.contains(.editedCharacters) {
            ...
            os_log("willProcessEditing textStorage.string: %@", log: Log.WriterCommon.textStorage, type: .info, %%textStorage.string)
            #endif
            ...
            if let rangeString = rangeString {
                ...
                if changeDescription.changeType != .unchanged {
                    ...
                    if let currentChangeDescription = editorManager.currentChangeDescription, changeDescription.changeType == .pureReplace
                        ...
                        let changeDescription = currentChangeDescription.same(with: changeDescription.utf16SubsequenceReplacement, targetString: textStorage.string)
