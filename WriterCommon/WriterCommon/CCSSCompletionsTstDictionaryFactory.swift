//
//  CCSSCompletionsTstDictionaryFactory.swift
//  WriterCommon
//
...
public final class CCSSCompletionsTstDictionaryFactory: CompletionsTstDictionaryFactory {
    
    public static func GetCcssTstDictionary() -> TstDictionary<CompletionValue> {
...
//        
//        try! tstDictionary.add(§CSSProperty.BackgroundColor, value: "BackgroundColor")
//        
//        try! tstDictionary.add(§CSSProperty.FontFamily, value: "FontFamily")
//        
//        try! tstDictionary.add(§CSSProperty.TextDecorationColor, value: "text-decoration-color")
//        
//        try! tstDictionary.add(§CSSProperty.TextDecorationLine, value: "text-decoration-line")
//        
//        try! tstDictionary.add(§CSSProperty.TextDecorationStyle, value: "text-decoration-style")
