//
//  MarkdownLeftAlignedTableElementStylingDocumentStoreTests.swift
//  WriterCommonTests
//
...
|q| r s |
*/
class MarkdownLeftAlignedTableElementStylingDocumentStoreTests: MarkdownStylingDocumentStoreTests {
    
    // | 1 | 2 |
    func testTableTag1() {
        
        let compiledAttributes = computeAttributes(markdownFileName: "left-aligned-table.md", styleFilename: "table-styling-style.css")
    ...
    // | :- |:--|
    //    -
    func testTableSeparatorContent11() {
    ...
    // | :- |:--|
    //       -
    func testTableSeparatorContent21() {
    ...
    // | :- |:--|
    //         -
    func testTableSeparatorContent4() {
    ...
    func testTableBody1Content1() {
        ...
        let result = WriterCommonTests.validateColor(in: compiledAttributes, at: 23, expected: red)
    ...
    func testTableBody1Content2() {
        ...
        let result = WriterCommonTests.validateColor(in: compiledAttributes, at: 24, expected: red)
    ...
    func testTableBody1Content3() {
        ...
        let result = WriterCommonTests.validateColor(in: compiledAttributes, at: 29, expected: red)
    ...
    func testTableBody2Content3() {
        ...
        let result = WriterCommonTests.validateColor(in: compiledAttributes, at: 39, expected: red)
    ...
    func testTableBody3Content2() {
        ...
        let result = WriterCommonTests.validateColor(in: compiledAttributes, at: 45, expected: red)
    ...
    func testTableBody3Tag1() {
        ...
        let result = WriterCommonTests.validateColor(in: compiledAttributes, at: 47, expected: blue)
    ...
    func testTableBody3Content3() {
        ...
        let result = WriterCommonTests.validateColor(in: compiledAttributes, at: 49, expected: red)
    ...
    func testTableBody4Tag1() {
        ...
        let result = WriterCommonTests.validateColor(in: compiledAttributes, at: 52, expected: blue)
    ...
    func testTableBody4Content3() {
        ...
        let result = WriterCommonTests.validateColor(in: compiledAttributes, at: 56, expected: red)
    ...
    func testTableBody5Tag2() {
        ...
        let result = WriterCommonTests.validateColor(in: compiledAttributes, at: 62, expected: blue)
