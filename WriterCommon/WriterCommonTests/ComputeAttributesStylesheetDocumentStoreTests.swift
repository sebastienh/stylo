//
//  ComputeAttributesStylesheetDocumentStoreTests.swift
//  WriterCommonTests
//
...
class ComputeAttributesStylesheetDocumentStoreTests: StylesheetDocumentStoreTests {

    func testCompileStylesheetAttributes() {
