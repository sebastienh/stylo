...
class ParagraphFocusTests: MarkdownRendererTests {
    ...
    func testFocusParagraphOnSelectionChange2() {
        ...
        XCTAssert(markdownContext.markdownStyleStore.focusMode.value == FocusMode.enabled(focusType: .paragraph))
    ...
    func testFocusParagraphOnSelectionAndScroll() {
        ...
        markdownContext.applySelectionChange(selectionRange: NSMakeRange(6, 0), visibleRange: NSMakeRange(0, 32))
        markdownContext.scroll(focusMode: FocusMode.enabled(focusType: FocusType.paragraph))
    ...
    func testFocusParagraphInHeader() {
