//
//  MarkdownLinkElementStylingDocumentStoreTests.swift
//  WriterCommonTests
//
...
[label]: a
*/
class MarkdownLinkElementStylingDocumentStoreTests: MarkdownStylingDocumentStoreTests {
    
    // [text](www.link.com "title")
    // -
    func testLinkTag1() {
        
        let compiledAttributes = computeAttributes(markdownFileName: "link-styling.md", styleFilename: "link-styling-style.css")
    ...
    func testLinkText1() {
        ...
        let result = WriterCommonTests.validateColor(in: compiledAttributes, at: 1, expected: yellow)
    ...
    func testLinkText3() {
        ...
        let result = WriterCommonTests.validateColor(in: compiledAttributes, at: 3, expected: yellow)
    ...
    func testLinkText4() {
        ...
        let result = WriterCommonTests.validateColor(in: compiledAttributes, at: 4, expected: yellow)
    ...
    func testIndex18() {
        ...
        let result = WriterCommonTests.validateColor(in: compiledAttributes, at: 18, expected: pink)
    ...
    func testIndex20() {
        ...
        let result = WriterCommonTests.validateColor(in: compiledAttributes, at: 20, expected: white)
    ...
    func testIndex21() {
        ...
        let result = WriterCommonTests.validateColor(in: compiledAttributes, at: 21, expected: white)
    ...
    func testIndex22() {
        ...
        let result = WriterCommonTests.validateColor(in: compiledAttributes, at: 22, expected: white)
    ...
    func testIndex26() {
        ...
        let result = WriterCommonTests.validateColor(in: compiledAttributes, at: 26, expected: white)
    ...
    func testIndex30() {
        ...
        let result = WriterCommonTests.validateColor(in: compiledAttributes, at: 30, expected: yellow)
    ...
    func testIndex31() {
        ...
        let result = WriterCommonTests.validateColor(in: compiledAttributes, at: 31, expected: yellow)
    ...
    func testIndex32() {
        ...
        let result = WriterCommonTests.validateColor(in: compiledAttributes, at: 32, expected: yellow)
    ...
    func testIndex33() {
        ...
        let result = WriterCommonTests.validateColor(in: compiledAttributes, at: 33, expected: yellow)
