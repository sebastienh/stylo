//
//  HtmlDomRendererStrikethroughTests.swift
//  WriterCommon
//
...
class HtmlDomRendererStrikethroughTests: XCTestCase {
    ...
    func testSimpleStrikethrough() {
        ...
        htmlDomValidator.pushNodeNameToValidate("s")
