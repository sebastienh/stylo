//
//  HtmlDomRendererListTests.swift
//  WriterCommon
//
//  Created by Sébastien Hamel on 2016-04-19.
...
class HtmlDomRendererListTests: XCTestCase {
    ...
    func testBasicListHtmlHDom() {
        ...
        htmlDomValidator.pushNodeNameToValidate("ul")
        htmlDomValidator.pushNodeNameToValidate("#text")
        htmlDomValidator.pushNodeNameToValidate("li")
        htmlDomValidator.pushNodeNameToValidate("#text")
        htmlDomValidator.pushNodeNameToValidate("#text")
        htmlDomValidator.pushNodeNameToValidate("li")
        htmlDomValidator.pushNodeNameToValidate("#text")
    ...
    func testListOffsetHtmlDom() {
        ...
        htmlDomValidator.pushNodeNameToValidate("head")
        htmlDomValidator.pushNodeNameToValidate("body")
        htmlDomValidator.pushNodeNameToValidate("ol")
        htmlDomValidator.pushNodeNameToValidate("#text")
        htmlDomValidator.pushNodeNameToValidate("li")
        htmlDomValidator.pushNodeNameToValidate("#text")
        htmlDomValidator.pushNodeNameToValidate("#text")
