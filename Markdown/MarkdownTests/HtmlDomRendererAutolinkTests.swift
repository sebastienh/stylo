//
//  HtmlDomRendererAutolinkTests.swift
//  WriterCommon
//
...
class HtmlDomRendererAutolinkTests: XCTestCase {
    ...
    func testBasicAutolink() {
        ...
        let src = "<http://foo.bar.baz/test?q=hello&id=22&boolean>\n # titre 1"
        ...
        htmlDomValidator.pushNodeNameToValidate("a")
