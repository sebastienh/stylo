//
//  HtmlDomRendererReferenceTests.swift
//  WriterCommon
//
...
class HtmlDomRendererReferenceTests: XCTestCase {
    ...
    func testReferenceHtmlHDom() {
        ...
        htmlDomValidator.pushNodeNameToValidate("reference")
