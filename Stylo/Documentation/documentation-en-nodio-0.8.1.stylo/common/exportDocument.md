...
The export function will export all selected files shown in the currently selected [Editors Panel](../nodio#editorsPanel). So any combination is possible as long as it can be shown in the [Editors Panel](../nodio#editorsPanel). 
