...
Pour créer un bloc citation:

- Textuellement, entrer `>` au début d'une ligne, pour plus d'information voir les [spécifications CommonMark](https://spec.commonmark.org/) 
- Depuis le menu, choissisez: `Format` → `Bloc citation`
- Depuis l'onglet « Outils » de la barre latérale, sélectionner le texte à transformer en un bloc ciation et cliquer sur le bouton `>`

#### Créer une liste non ordonnée 

Pour créer une liste non ordonnée:

- Textuellement, entrer `-` au début de chaque ligne de la liste , pour plus d'information voir les [spécifications CommonMark](https://spec.commonmark.org/) 
- Depuis le menu, choissisez: `Format` → `Liste Non Ordonnée`
- Depuis l'onglet « Outils » de la barre latérale, sélectionner le texte à transformer en un bloc ciation et cliquer sur le bouton `-`
...
- Textuellement, entrer les numéros au début de chaque ligne de la liste, par exemple: `1.`, pour plus d'information voir les [spécifications CommonMark](https://spec.commonmark.org/) 
- Depuis le menu, choissisez: `Format` → `Liste Ordonnée`
- Depuis l'onglet « Outils » de la barre latérale, sélectionner le texte à transformer en liste ordonnée et cliquer sur le bouton `1.`

#### Convertir en gras 

Pour convertir en gras:

- Textuellement, entourer le text à mettre en gras des charactères « ** » à gauche et à droite, pour plus d'information voir les [spécifications CommonMark](https://spec.commonmark.org/) 
- Depuis le menu, choissisez: `Format` → `Gras`
- Depuis l'onglet « Outils » de la barre latérale, sélectionner le texte à transformer en  gras et cliquer sur le bouton `B`

#### Convertir en italique 

Pour convertir en italique:

- Textuellement, entourer le text à mettre en italique des charactères « * » à gauche et à droite, pour plus d'information voir les [spécifications CommonMark](https://spec.commonmark.org/) 
- Depuis le menu, choissisez: `Format` → `Italique`
- Depuis l'onglet « Outils » de la barre latérale, sélectionner le texte à transformer en  italique et cliquer sur le bouton `I`
...
- Textuellement: un lien a la forme générale [<nom du lien>](<destination du lien>), par exemple, `[Stylo](http://stylo.app)` pour plus d'information voir les [spécifications CommonMark](https://spec.commonmark.org/) 
