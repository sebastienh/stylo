...
Note: for a full/alternative explanation of CSS priority rules and cascading process: [How CSS works: Understanding the cascade](https://blog.logrocket.com/how-css-works-understanding-the-cascade-d181cd89a4d8/).
