...
- From the [_Markdown Quick Formatting Tools_](#markdownQuickFormattingTools), select the text to be transformed into an ordered list and click on the `1.` button
