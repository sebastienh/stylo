...
- From the [_Markdown Quick Formatting Tools_](#markdownQuickFormattingTools), select the text to be transformed into a unordered list and click on the `-` button.
