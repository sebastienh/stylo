...
- From the [_Markdown Quick Formatting Tools_](#markdownQuickFormattingTools), select the text to be transformed into a citation block and click on the `>` button.
