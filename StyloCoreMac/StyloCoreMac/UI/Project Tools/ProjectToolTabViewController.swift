...
class FilesOutlineSelectorTabViewController: NSTabViewController {
    ...
    func addPanel(withFilesOutlineManager filesOutlineManager: FilesOutlineManager, atIndex index: Int) {
